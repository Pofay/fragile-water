defmodule FragileWater.Mangos.ItemTemplate do
  use Ecto.Schema
  ...
  schema "item_template" do
    ...
    field(:unk0, :integer, default: 0)
    field(:name, :string, default: "")
    field(:display_id, :integer, default: 0, source: :displayid)
    field(:quality, :integer, default: 0, source: :Quality)
    field(:flags, :integer, default: 0, source: :Flags)
    ...
    # TBC fields
    field(:totem_category, :integer, default: 0, source: :TotemCategory)
    field(:socket_color_1, :integer, default: 0, source: :socketColor_1)
    field(:socket_content_1, :integer, default: 0, source: :socketContent_1)
    field(:socket_color_2, :integer, default: 0, source: :socketColor_2)
    field(:socket_content_2, :integer, default: 0, source: :socketContent_2)
    field(:socket_color_3, :integer, default: 0, source: :socketColor_3)
    field(:socket_content_3, :integer, default: 0, source: :socketContent_3)
    field(:socket_bonus, :integer, default: 0, source: :socketBonus)
    field(:gem_properties, :integer, default: 0, source: :GemProperties)
    field(:required_disenchant_skill, :integer, default: 0, source: :RequiredDisenchantSkill)
    field(:armor_damage_modifier, :float, default: 0.0, source: :ArmorDamageModifier)
    field(:script_name, :string, default: "", source: :ScriptName)
    # End of TBC fields
